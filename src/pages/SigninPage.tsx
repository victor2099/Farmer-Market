...
const SigninPage = () => {
  return (
     <div>
         <div className="font-dm-sans grid justify-center  h-full w-full md:grid-cols-[repeat(2,1fr)] gap-3 md:gap-10  max-w-7xl mx-auto  ">
        ...
        <div className="mt-5 md:mt-10 max-w-lg md:mr-20">
